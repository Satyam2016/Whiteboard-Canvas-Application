...
const CreateRoomForm = () => {
     ...
     return (
          <div className=" flex  border rounded-lg items-center  w-96 justify-center text-white">
                    ...
                    <form className="flex flex-col gap-4">
                         ...
                         <div className="flex flex-row">
                              ...
                              <button
                                   ...
                                   className="py-3 px-6 bg-blue-500 text-lg font-medium rounded-r-lg hover:bg-blue-600 transition-transform transform hover:scale-105" 
                              >
                                   Copy
                              </button>
                         </div>
